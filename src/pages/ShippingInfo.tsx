        ...
        <div className="max-w-3xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-12">
            <div className="bg-card border border-border rounded-2xl p-5 flex flex-col gap-3">
              ...
              <h3 className="font-body font-bold text-foreground text-base">Delivery Time</h3>
            ...
            <div className="bg-card border border-border rounded-2xl p-5 flex flex-col gap-3">
              ...
              <h3 className="font-body font-bold text-foreground text-base">Pan India</h3>
              <p className="text-base text-muted-foreground">
            ...
            <div className="bg-card border border-border rounded-2xl p-5 flex flex-col gap-3">
              ...
              <h3 className="font-body font-bold text-foreground text-base">Tracking</h3>
              <p className="text-base text-muted-foreground">
          ...
          <div className="space-y-8 text-base text-muted-foreground leading-relaxed">
            <div>
              <h2 className="font-body font-bold text-xl text-foreground mb-3">
                Processing Time
              </h2>
              <p>
          ...
          <div className="mt-12 bg-card border border-border rounded-2xl p-6">
            <h2 className="font-body font-bold text-lg text-foreground mb-4">
              Need help with your shipment?
            </h2>
            <div className="flex flex-col sm:flex-row gap-4 text-base">
              <a
                href="mailto:hello@poppigo.co"
                className="flex items-center gap-2 text-muted-foreground hover:text-[#4241ff] transition-colors"
              >
                <Mail size={16} />
                hello@poppigo.co
              </a>
