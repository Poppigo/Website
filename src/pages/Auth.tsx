          ...
          {isForgot ? (
            <form onSubmit={handleForgotPassword} className="space-y-4">
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full bg-secondary text-secondary-foreground py-3 rounded-full font-semibold hover:opacity-90 transition-opacity disabled:opacity-50"
              >
            ...
            <>
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-3 border border-border bg-background py-3 rounded-full font-semibold text-foreground hover:bg-muted transition-colors disabled:opacity-50"
              >
