        ...
        >
          ...
          <div className="bg-card rounded-3xl border border-border overflow-hidden shadow-lg">
              ...
              >
                <div className="bg-muted rounded-2xl px-4 py-3 flex items-center justify-between">
                  <div className="flex items-center gap-2.5">
                    ...
                    <span className="text-xs text-muted-foreground font-medium uppercase tracking-wide">Order Number</span>
                  </div>
                  <span className="font-display font-bold text-foreground text-sm">#{orderNumber}</span>
                </div>
              </motion.div>
            )}
            ...
            <div className="px-8 pb-8 flex flex-col gap-3">
              <Link
                to="/my-orders"
                className="w-full inline-flex items-center justify-center gap-2 bg-secondary text-secondary-foreground px-6 py-3.5 rounded-full font-display font-semibold hover:opacity-90 transition-opacity"
              >
                <Package size={16} />
                Track My Order
              </Link>
