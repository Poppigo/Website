    ...
    <div className="min-h-screen bg-peach">
      ...
      <div className="pt-24 pb-20">
        <div className="max-w-3xl mx-auto px-6">
          ...
          <div className="mt-12 pt-8 border-t border-border text-base text-muted-foreground space-y-1">
            <h2 className="font-body font-bold text-xl text-foreground mb-3">Contact Us</h2>
