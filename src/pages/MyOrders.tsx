    ...
    <div className="min-h-screen bg-peach">
      ...
      <div className="pt-24 pb-20">
        <div className="max-w-4xl mx-auto px-6">
          ...
          <h1 className="font-display text-4xl md:text-5xl font-bold text-foreground mb-10">My Orders</h1>
                  ...
                  >
                    <div className="flex flex-wrap items-center justify-between gap-3 mb-4">
                      ...
                      <div className="text-right">
                        <p className="font-display font-bold text-coral">₹{Number(order.amount).toLocaleString()}</p>
                        <span className={`inline-block px-2.5 py-1 rounded-full text-xs font-semibold mt-1 ${statusColor[order.status] || "bg-muted text-muted-foreground"}`}>
                          {order.status}
                        </span>
                      </div>
                    </div>
