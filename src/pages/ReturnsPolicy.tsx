        ...
        <div className="max-w-3xl mx-auto px-6">
          ...
          <div className="flex items-start gap-4 bg-card border border-border rounded-2xl p-5 mb-12">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground leading-relaxed">
                ...
                email us at{" "}
                <a href="mailto:ecomm@poppigo.co" className="text-coral hover:underline">
                  ecomm@poppigo.co
                </a>{" "}
          ...
          <div className="space-y-8 text-sm text-muted-foreground leading-relaxed">
            ...
            <div>
              ...
              <p>
                Refunds are not offered as a standard resolution due to the hygiene nature of our
                products. In exceptional cases — such as a COD order cancelled before dispatch or a
                payment error — a refund will be processed to your original payment method within{" "}
