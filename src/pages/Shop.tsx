      ...
      <div className="pt-24 pb-20">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-foreground/50 text-lg mt-3 font-body max-w-md mx-auto">
                      ...
                      >
                        ...
                        >
                          ...
                          {product.original_price && product.original_price > product.price && (
                            <div className="absolute top-3 left-3 bg-lime text-foreground px-2.5 py-1 rounded-full text-xs font-bold">
                        ...
                        <div className="p-3 sm:p-5 flex flex-col justify-between flex-1">
                          <div>
                            <Link to={`/product/${product.id}`}>
                              <h3 className="font-display font-bold text-foreground text-xs sm:text-base leading-snug mb-1 sm:mb-2 line-clamp-2 hover:text-[#4241ff] transition-colors">
                                {product.name}
                              </h3>
                            </Link>
